...
try{
    ...
    $qry = $con->query($sql);
    $serv = $qry->fetchAll(PDO::FETCH_OBJ);
...
<hr>
    <a href="servicos.php"  class="btn btn-primary">Novo Cadastro</a>
<hr>
<table class="table table-striped table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="servicos.php?idserv=<?php echo $serv->idserv ?>" class="btn btn-success">Editar</a></td>
            <td><a href="servicos.php?op=del&idserv=<?php echo $serv->idserv ?>" class="btn btn-danger">Excluir</a></td>
