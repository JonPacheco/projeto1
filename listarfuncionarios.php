...
<hr>
    <a href="frmfuncionarios.php"  class="btn btn-primary">Novo Cadastro</a>
<hr>
<table class="table table-striped table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="frmfuncionarios.php?idfunc=<?php echo $func->idfunc ?>" class="btn btn-success">Editar</a></td>
            <td><a href="frmfuncionarios.php?op=del&idfunc=<?php echo $func->idfunc ?>" class="btn btn-danger">Excluir</a></td>
